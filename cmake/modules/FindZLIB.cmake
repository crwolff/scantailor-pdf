...
if(NOT ZLIB_LIBRARY)
  ...
  if(WIN32)
    ...
    list(APPEND CMAKE_FIND_LIBRARY_SUFFIXES ".dll.a" ".lib")
  endif()
  ...
  foreach(search ${_ZLIB_SEARCHES})
    find_library(ZLIB_LIBRARY_RELEASE NAMES ${ZLIB_NAMES} NAMES_PER_DIR ${${search}} PATH_SUFFIXES lib bin)
    find_library(ZLIB_LIBRARY_DEBUG NAMES ${ZLIB_NAMES_DEBUG} NAMES_PER_DIR ${${search}} PATH_SUFFIXES lib bin)
  endforeach()
  ...
  if(WIN32 AND NOT ZLIB_USE_STATIC_LIBS)
    ...
    foreach(search ${_ZLIB_SEARCHES})
      find_library(ZLIB_DLL_RELEASE NAMES ${ZLIB_NAMES} NAMES_PER_DIR ${${search}} PATH_SUFFIXES bin) 
      find_library(ZLIB_DLL_DEBUG NAMES ${ZLIB_NAMES_DEBUG} NAMES_PER_DIR ${${search}} PATH_SUFFIXES bin)
    endforeach()
  endif()
